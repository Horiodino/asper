...
type Network interface {
	...
	DeleteNetworkInterface(ctx context.Context, nicinput DeleteNetworkInterfaceParams) (*result qemu.DeleteNetworkInterfaceResult, err error)
...
func (n *network) DeleteNetworkInterface(ctx context.Context, nicinput DeleteNetworkInterfaceParams) (result qemu.DeleteNetworkInterfaceResult, err error) {
	return result, err
}
